...
- La sottolinea `BINANCE` della tab crypto main non deve mostrare marker standalone: se esiste un solo punto Binance non disegna nulla; quando ci sono almeno due snapshot/punti storici, disegna una linea reale.
