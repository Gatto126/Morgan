...
- La sottolinea `BINANCE` della tab crypto main deve restare visibile/togglabile anche quando esiste un solo punto Binance: in quel caso si mostra un marker standalone, non una linea inventata.
